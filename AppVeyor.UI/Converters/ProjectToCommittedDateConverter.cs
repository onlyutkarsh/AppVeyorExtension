...
{
    public class ProjectToCommittedDateConverter : BaseConverter, IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (project != null && !project.Builds.IsEmpty())
            {
                ...
                DateTime dateTime;
                if(DateTime.TryParse(build.Committed, out dateTime))
                {
                    return dateTime.PrettyDate();
                }
                return build.Committed;
            }
            return string.Empty;
        }
